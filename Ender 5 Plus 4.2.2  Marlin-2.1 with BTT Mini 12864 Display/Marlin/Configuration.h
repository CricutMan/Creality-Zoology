...
#define STRING_CONFIG_H_AUTHOR "(cricutman, Creality Ender-5 Plus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tim's Ender-5 Plus"
...
//
#define PREHEAT_1_LABEL       "PLA/TPU"
